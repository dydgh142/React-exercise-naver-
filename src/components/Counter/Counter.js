  ...
  return (
    <div className="counter">
      <div className="counter-button">
        <button className="counter-minus" onClick={onDecrease}>
          -
        </button>
        <span className="counter-result">{count}</span>
        <button className="counter-plus" onClick={onIncrease}>
          +
        </button>
      </div>
      <div className="total">
        <div className="totalFirst">
          <span>총 상품 금액</span>
          <img src="assets/tooltip.svg" alt="툴팁 이미지" />
        </div>
        <div className="totlaSecond">
          <span className="totalSecond-text">총 수량 </span>
          <span className="totalSecond-number" onClick={onIncrease}>
            {count}
          </span>
